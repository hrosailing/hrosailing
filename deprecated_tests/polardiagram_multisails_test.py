...
'''
Multisails test temporarily not available
'''
# import unittest
#
# import numpy as np
...
#         for i in range(6):
#             with self.subTest(i=i):
#                 helper_functions.multisails_plot_polar_comparing_x_plot_wa_y_plot_bsp(i, self.wind_angles, bsps)
#
...
#         helper_functions.test_multisails_comparing_show_legend(self, plt.gca().get_legend())
#
...
#         for i in range(6):
#             with self.subTest(i=i):
#                 helper_functions.multisails_plot_flat_comparing_x_plot_wa_y_plot_bsp(i, self.wind_angles, bsps)
#
...
#         helper_functions.test_multisails_comparing_show_legend(self,
#                                                                       plt.gca().get_legend())
#
