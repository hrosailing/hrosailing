...
"url":1,
"doc":"Reads a .csv file and returns the PolarDiagram instance contained in it Parameters      csv_path : path-like Path to a .csv file fmt : string The \"format\" of the .csv file. - hro: format created by the to_csv-method of the PolarDiagram class - orc: format found at  ORC   _ - opencpn: format created by  OpenCPN Polar Plugin   _ - array tw : bool Specifies if wind data in file should be viewed as true wind Defaults to True Returns    - out : PolarDiagram PolarDiagram instance contained in the .csv file Raises a FileReadingException - if an unknown format was specified - if an error occurs whilst reading",
"func":1
},
{
...
"url":1,
"doc":"Base class for all polardiagram classes Methods    - pickling(pkl_path) Writes PolarDiagram instance to a .pkl file polar_plot_slice(ws, ax=None,  plot_kw) Creates a polar plot of a given slice of the polar diagram flat_plot_slice(ws, ax=None,  plot_kw) Creates a cartesian plot of a given slice of the polar diagram plot_convex_hull_slice(ws, ax=None,  plot_kw) Computes the convex hull of a given slice of the polar diagram and creates a polar plot of it Abstract Methods         to_csv(csv_path) symmetrize() get_slices(ws) plot_polar( ws, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw ) plot_flat( ws, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw ) plot_3d(ax=None,  plot_kw) plot_color_gradient( ax=None, colors=(\"green\", \"red\"), marker=None, ms=None, show_legend=False,  legend_kw, ) plot_convex_hull( ws, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, )"
},
{
...
"url":1,
"doc":"A class to represent, visualize and work with a polar diagram in the form of a table. Parameters      ws_res : array_like or positive int/float, optional Wind speeds that will correspond to the columns of the table Can either be a sequence of length cdim or an int/float value If a number num is passed, numpy.arange(num, 40, num) will be assigned to ws_res If nothing is passed, it will default to numpy.arange(2, 42, 2) wa_res : array_like or positive int/float, optional Wind angles that will correspond to the rows of the table. Should be between 0\u00b0 and 360\u00b0 Can either be sequence of length rdim or an int/float value If a number num is passed, numpy.arange(num, 360, num) will be assigned to wa_res If nothing is passed, it will default to numpy.arange(0, 360, 5) bsps : array_like, optional Boatspeeds that will correspond to the entries of the table Should be broadcastable to the shape (rdim, cdim) If nothing is passed it will default to numpy.zeros rdim, cdim Raises a PolarDiagramException - if bsps can't be broadcasted to a fitting shape - if bsps is not of dimension 2 - if bsps is an empty array Methods    - wind_speeds Returns a read only version of self._res_wind_speed wind_angles Returns a read only version of self._res_wind_angle boat_speeds Returns a read only version of self._boat_speeds to_csv(csv_path, fmt=\"hro\") Creates a .csv-file with delimiter ',' and the following format: PolarDiagramTable Wind speed resolution: self.wind_speeds Wind angle resolution: self.wind_angles Boat speeds: self.boat_speeds symmetrize() Constructs a symmetric version of the polar diagram, by mirroring it at the 0\u00b0 - 180\u00b0 axis and returning a new instance change_entries(data, ws=None, wa=None, tw=True) Changes specified entries in the table plot_polar( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a polar plot of one or more slices of the polar diagram plot_flat( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a cartesian plot of one or more slices of the polar diagram plot_3d(ax=None,  plot_kw) Creates a 3d plot of the polar diagram plot_color_gradient( ax=None, colors=(\"green\", \"red\"), marker=None, ms=None, show_legend=False,  legend_kw, ) Creates a 'wind speed vs. wind angle' color gradient plot of the polar diagram with respect to the respective boat speeds plot_convex_hull( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Computes the (seperate) convex hull of one or more slices of the polar diagram and creates a polar plot of them"
},
{
...
"url":1,
"doc":"A class to represent, visualize and work with a polar diagram made up of multiple sets of sails, represented by a PolarDiagramTable Parameters      pds : Iterable of PolarDiagramTable objects sails : Iterable, optional Raises a PolarDiagramException if Methods    - wind_speeds Returns a read only version of self._res_wind_speed wind_angles Returns a read only version of self._res_wind_angle boat_speeds Returns a list of pt.boat_speeds for every PolarDiagramTable pt in self._sails to_csv(csv_path) symmetrize() Constructs a symmetric version of the polar diagram, by mirroring each PolarDiagramTable at the 0\u00b0 - 180\u00b0 axis and returning a new instance get_slices(ws) plot_polar( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a polar plot of one or more slices of the polar diagram plot_flat( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a cartesian plot of one or more slices of the polar diagram plot_3d(ax=None,  plot_kw) Creates a 3d plot of the polar diagram plot_color_gradient( ax=None, colors=(\"green\", \"red\"), marker=None, ms=None, show_legend=False,  legend_kw, ) plot_convex_hull( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Computes the (seperate) convex hull of one or more slices of the polar diagram and creates a polar plot of them"
},
{
...
"url":1,
"doc":"A class to represent, visualize and work with a polar diagram given by a fitted curve/surface. Parameters      f : function Curve/surface that describes the polar diagram, given as a function, with the signature f(x,  params) -> y, where x is a numpy.ndarray of shape (n, 2) which corresponds to pairs of wind speed and wind angle and y is a numpy.ndarray of shape (n, ) or (n, 1) which corresponds to the boat speed at the resp. wind speed and wind angle. params : tuple or Sequence Optimal parameters for f radians : bool, optional Specifies if f takes the wind angles to be in radians or degrees Defaults to False Methods    - curve Returns a read only version of self._f parameters Returns a read only version of self._params radians Returns a read only version of self._rad to_csv(csv_path) Creates a .csv-file with delimiter ':' and the following format: PolarDiagramCurve Function: self.curve Radians: self.rad Parameters: self.parameters symmetrize() get_slices(ws) plot_polar( ws=None, stepsize=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a polar plot of one or more slices of the polar diagram plot_flat( ws=None, stepsize=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a cartesian plot of one or more slices of the polar diagram plot_3d(ws=None, stepsize=None, ax=None,  plot_kw) Creates a 3d plot of a part of the polar diagram plot_color_gradient( ws=None, stepsize=None, ax=None, colors=(\"green\", \"red\"), marker=None, ms=None, show_legend=False,  legend_kw, ) Creates a 'wind speed vs. wind angle' color gradient plot of a part of the polar diagram with respect to the respective boat speeds plot_convex_hull( ws=None, stepsize=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Computes the (seperate) convex hull of one or more slices of the polar diagram and creates a polar plot of them"
},
{
...
"url":1,
"doc":"A class to represent, visualize and work with a polar diagram given by a point cloud Parameters      pts : array_like of shape (n, 3), optional Initial points of the point cloud, given as a sequence of points consisting of wind speed, wind angle and boat speed If nothing is passed, the point cloud will be initialized as an empty point cloud tw : bool, optional Specifies if the given wind data should be viewed as true wind If False, wind data will be converted to true wind Defaults to True Raises a PolarDiagramException - if - if Methods    - wind_speeds Returns all unique wind speeds in the point cloud wind_angles Returns all unique wind angles in the point cloud points Returns a read only version of self._pts to_csv(csv_path) Creates a .csv-file with delimiter ',' and the following format: PolarDiagramPointcloud True wind speed: , True wind angle: , Boat speed: self.get_points symmetrize() add_points(new_pts) Adds additional points to the point cloud get_slices(ws) polar_plot( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a polar plot of one or more slices of the polar diagram flat_plot( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Creates a cartesian plot of one or more slices of the polar diagram plot_3d(ax=None,  plot_kw) Creates a 3d plot of the polar diagram plot_color_gradient( ax=None, colors=(\"green\", \"red\"), marker=None, ms=None, show_legend=False,  legend_kw ) Creates a 'wind speed vs. wind angle' color gradient plot of the polar diagram with respect to the respective boat speeds plot_convex_hull( ws=None, ax=None, colors=(\"green\", \"red\"), show_legend=False, legend_kw=None,  plot_kw, ) Computes the (seperate) convex hull of one or more slices of the polar diagram and creates a polar plot of them"
},
{
...
"url":1,
"doc":"Creates a polar plot of one or more slices of the polar diagram Parameters      ws : tuple of length 2, iterable , int or float, optional Slices of the polar diagram given as either - a tuple of length 2 specifying an interval of considered wind speeds - an iterable of specific wind speeds - a single wind speed Slices will then consist of all the rows in self.points whose first entry is equal to the values in  ws Defaults to self.wind_speeds stepsize : positive int, optional range_ : positive int or float, optional ax : matplotlib.projections.polar.PolarAxes, optional Axes instance where the plot will be created. If nothing is passed, the function will create a suitable axes colors : tuple, optional Specifies the colors to be used for the different slices. There are four options - If as many or more colors as slices are passed, each slice will be plotted in the specified color - If exactly 2 colors are passed, the slices will be plotted with a color gradient consiting of the two colors - If more than 2 colors but less than slices are passed, the first n_color slices will be plotted in the specified colors, and the rest will be plotted in the default color 'blue' Alternatively one can specify certain slices to be plotted in a certain color by passing a tuple of (ws, color) pairs Defaults to (\"green\", \"red\") show_legend : bool, optional Specifies wether or not a legend will be shown next to the plot The type of legend depends on the color options - If the slices are plotted with a color gradient, a matplotlib.colorbar.Colorbar object will be created and assigned to ax. - Otherwise a matplotlib.legend.Legend will be created and assigned to ax. Defaults to False legend_kw : dict, optional Keyword arguments to be passed to either the matplotlib.colorbar.Colorbar or matplotlib.legend.Legend classes to change position and appearence of the legend Will only be used if show_legend is True If nothing is passed it will default to {} plot_kw : Keyword arguments Keyword arguments that will be passed to the matplotlib.axes.Axes.plot function, to change certain appearences of the plot Raises a PolarDiagramException if ws is given as a single value or a list and there is a value w in ws, such that there are no rows in self.points whose first entry is equal to w",
"func":1
},
{
"ref":"hrosailing.polardiagram.PolarDiagramPointcloud.plot_flat",
"url":1,
"doc":"Creates a cartesian plot of one or more slices of the polar diagram Parameters      ws : tuple of length 2, iterable , int or float, optional Slices of the polar diagram given as either - a tuple of length 2 specifying an interval of considered wind speeds - an iterable of specific wind speeds - a single wind speed Slices will then consist of all the rows in self.points whose first entry is equal to the values in  ws Defaults to self.wind_speeds stepsize : positive int, optional range_ : positive int or float, optional ax : matplotlib.projections.polar.PolarAxes, optional Axes instance where the plot will be created. If nothing is passed, the function will create a suitable axes colors : tuple, optional Specifies the colors to be used for the different slices. There are four options - If as many or more colors as slices are passed, each slice will be plotted in the specified color - If exactly 2 colors are passed, the slices will be plotted with a color gradient consiting of the two colors - If more than 2 colors but less than slices are passed, the first n_color slices will be plotted in the specified colors, and the rest will be plotted in the default color 'blue' Alternatively one can specify certain slices to be plotted in a certain color by passing a tuple of (ws, color) pairs Defaults to (\"green\", \"red\") show_legend : bool, optional Specifies wether or not a legend will be shown next to the plot The type of legend depends on the color options - If the slices are plotted with a color gradient, a matplotlib.colorbar.Colorbar object will be created and assigned to ax. - Otherwise a matplotlib.legend.Legend will be created and assigned to ax. Defaults to False legend_kw : dict, optional Keyword arguments to be passed to either the matplotlib.colorbar.Colorbar or matplotlib.legend.Legend classes to change position and appearence of the legend Will only be used if show_legend is True If nothing is passed it will default to {} plot_kw : Keyword arguments Keyword arguments that will be passed to the matplotlib.axes.Axes.plot function, to change certain appearences of the plot Raises a PolarDiagramException if ws is given as a single value or a list and there is a value w in ws, such that there are no rows in self.points whose first entry is equal to w",
"func":1
},
{
...
"url":1,
"doc":"Computes the (seperate) convex hull of one or more slices of the polar diagram and creates a polar plot of them Parameters      ws : tuple of length 2, iterable , int or float, optional Slices of the polar diagram given as either - a tuple of length 2 specifying an interval of considered wind speeds - an iterable of specific wind speeds - a single wind speed Slices will then consist of all the rows in self.points whose first entry is equal to the values in  ws Defaults to self.wind_speeds stepsize : positive int, optional range_ : positive int or float, optional ax : matplotlib.projections.polar.PolarAxes, optional Axes instance where the plot will be created. If nothing is passed, the function will create a suitable axes colors : tuple, optional Specifies the colors to be used for the different slices. There are four options - If as many or more colors as slices are passed, each slice will be plotted in the specified color - If exactly 2 colors are passed, the slices will be plotted with a color gradient consiting of the two colors - If more than 2 colors but less than slices are passed, the first n_color slices will be plotted in the specified colors, and the rest will be plotted in the default color 'blue' Alternatively one can specify certain slices to be plotted in a certain color by passing a tuple of (ws, color) pairs Defaults to (\"green\", \"red\") show_legend : bool, optional Specifies wether or not a legend will be shown next to the plot The type of legend depends on the color options - If the slices are plotted with a color gradient, a matplotlib.colorbar.Colorbar object will be created and assigned to ax. - Otherwise a matplotlib.legend.Legend will be created and assigned to ax. Defaults to False legend_kw : dict, optional Keyword arguments to be passed to either the matplotlib.colorbar.Colorbar or matplotlib.legend.Legend classes to change position and appearence of the legend Will only be used if show_legend is True If nothing is passed it will default to {} plot_kw : Keyword arguments Keyword arguments that will be passed to the matplotlib.axes.Axes.plot function, to change certain appearences of the plot Raises a PolarDiagramException if ws is given as a single value or a list and there is a value w in ws, such that there are no rows in self.points whose first entry is equal to w",
"func":1
},
{
...
"url":5,
"doc":"A Pipeline class to create polar diagrams from raw data Parameters      extension: PipelineExtension handler : DataHandler weigher : Weigher, optional filter_ : Filter, optional Raises a PipelineException Methods    - __call__(self, data, tw=True, filtering=True)"
},
{
...
"url":7,
"doc":"An orthogonal distance regressor based on scipy.odr.odrpack Parameters      model_func : function The function which describes the model and is to be fitted. The function signature should be f(ws, wa,  params) -> bsp, where ws and wa are numpy.ndarrays resp. and params is a sequence of parameters that will be fitted init_values : array_like, optional Inital guesses for the optimal parameters of model_func that are passed to the scipy.odr.ODR class Defaults to None max_it : int, optional Maximum number of iterations done by scipy.odr.ODR. Defaults to 1000 Methods    - model_func optimal_params set_weight(self, X_weights, y_weights) fit(self, data)"
},
{
...
"url":8,
"doc":"A full featured inverse distance interpolator, based on the work of Shepard, \"A two-dimensional interpolation function for irregulary-spaced data\" Should (only) be used together with the ScalingBall neighbourhood Parameters      tol : positive float , optional Defautls to numpy.finfo(float).eps slope: positive float, optional Defaults to 0.1 norm : function or callable, optional Norm with which to calculate the distances, ie  . If nothing is passed, it will default to a scaled version of  . _2 Raises an InterpolatorException if inputs are not of the specified types Methods    - interpolate(self, w_pts, grid_pt) Interpolates a given grid_pt according to the above described method"
},
{
...
"url":9,
"doc":"A filter that filteres all points based on if their resp. weight lies above a certain quantile Parameters      percent: int or float, optional The quantile to be calculated Defaults to 25 Raises a FilterException, if percent is not in the interval [0, 100] Methods    - filter(self, wts) Filters a set of points given by their resp. weights"
},
{
...
"url":11,
"doc":"A weigher that weighs given points according to the following procedure: For a given point p and points pts we look at all the points pt in pts such that |pt[0] - p[0]| <= h and  pt[1:] - p[1:] <= r Call the set of all such points P, then w_p =  P - 1 Parameters      radius : positive int or float, optional The radius of the considered cylinder, ie r Defaults to 1 length : nonnegative int of float, optional The height of the considered cylinder, ie h If length is 0, the cylinder is a d-1 dimensional ball Defaults to 1 norm : function or callable, optional Norm with which to evaluate the distances, ie  . If nothing is passed, it will default to  . _2 Raises a WeigherException if inputs are not of the specified types Methods    - weigh(self, pts) Weigh given points according to the method described above"
},
{
...
"url":14,
"doc":"A sampler that produces a number of uniformly distributed samples, which all lie in the convex hull of certain given points Parameters      n_samples : positive int Amount of samples that will be produced by the sampler Raises SamplerException if input is not of specified type Methods    - sample(self, pts): Produces samples according to the above described procedure"
},
{
...
"url":14,
"doc":"A sampler that produces a number of approximately equidistant sample points on a moved and scaled version of the archimedean spiral (x cos(x), x sin(x . The sample points all lie in the smallest enclosing circle of given data points. Inspired by https: agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2007GC001581 Parameters      n_samples : positive int Amount of samples that will be produced by the sampler Raises SamplerException if input is not of specified type Methods    - sample(self, pts): Produces samples according to the above described procedure"
},
{
