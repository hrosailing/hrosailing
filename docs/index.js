...
{
"ref":"hrosailing.polardiagram.NotYetImplementedWarning",
"url":1,
"doc":"Simple Warning for not fully finished implementations"
},
{
"ref":"hrosailing.polardiagram.PolarDiagramMultiSails",
"url":1,
"doc":"A class to represent, visualize and work with a polar diagram made up of multiple sets of sails, represented by a PolarDiagramTable Class methods aren't fully developed yet. Take care when using this class Parameters      pds : Iterable of PolarDiagramTable objects Polar diagrams belonging to different sets of sails, given as tables, that share the same wind speeds sails : Iterable, optional Custom names for the sails. Length should be equal to pds If it is not equal it will either be cut off at the appropriate length or will be addended with  \"Sail i\" to the appropriate length Only important for the legend of plots or the to_csv()-method If nothing is passed, the names will be  \"Sail i\" , i = 0 .n-1, where  len(pds) = n . Raises a PolarDiagramException if the polar tables don't share the same wind speeds"
},
{
...
"url":1,
"doc":"Computes the (seperate) convex hull of one or more slices of the polar diagram and creates a polar plot of them Parameters      ws : tuple of length 2, iterable, int or float, optional Slices of the polar diagram table, given as either - a tuple of length 2 specifying an interval of considered wind speeds - an iterable containing only elements of self.wind_speeds - a single element of self.wind_speeds The slices are then equal to the corresponding columns of the table together with self.wind_angles If nothing it passed, it will default to self.wind_speeds ax : matplotlib.projections.polar.PolarAxes, optional Axes instance where the plot will be created. If nothing is passed, the function will create a suitable axes colors : subscriptable iterable of color_likes, optional show_legend : bool, optional Specifies wether or not a legend will be shown next to the plot The type of legend depends on the color options - If the slices are plotted with a color gradient, a matplotlib.colorbar.Colorbar object will be created and assigned to ax. - Otherwise a matplotlib.legend.Legend will be created and assigned to ax. Defaults to False legend_kw : dict, optional Keyword arguments to be passed to either the matplotlib.colorbar.Colorbar or matplotlib.legend.Legend classes to change position and appearence of the legend Will only be used if show_legend is True If nothing is passed it will default to {} plot_kw : Keyword arguments Keyword arguments that will be passed to the matplotlib.axes.Axes.plot function, to change certain appearences of the plot Raises a PolarDiagramException if at least one element of ws is not in self.wind_speeds",
"func":1
},
{
...
{
"ref":"hrosailing.polardiagram.PolarDiagramPointcloud.__call__",
"url":1,
"doc":"Returns the value of the polar diagram at a given ws-wa point If the ws-wa point is in the cloud, the corresponding boat speed is returned, otherwise the value is interpolated Parameters      ws : int or float The wind speed value of the ws-wa point wa : int or float The wind angle value of the ws-wa point interpolator : Interpolator, optional Interpolator subclass that determines the interpolation method used to determine the value at the ws-wa point Defaults to ArithmeticMeanInterpolator(50) neighbourhood : Neighbourhood, optional Neighbourhood subclass used to determine the points in the point cloud that will be used in the interpolation Defaults to Ball(radius=1) Returns    - bsp : int or float",
"func":1
},
{
...
"url":1,
"doc":"Creates a 3d plot of the polar diagram Parameters      ax : mpl_toolkits.mplot3d.axes3d.Axes3D, optional Axes instance where the plot will be created. If nothing is passed, the function will create a suitable axes colors : subscriptable iterable of length 2 of color_likes, optional Color pair determining the color gradient (wrt the wind speed) with which the polar diagram will be plotted If no color gradient is desired, set both colors to the same value Defaults to (\"green\", \"red\") plot_kw : Keyword arguments Keyword arguments that will be passed to the matplotlib.axes.Axes.plot function, to change certain appearences of the plot Raises a PolarDiagramException if there are no points in the point cloud",
"func":1
},
{
...
"url":13,
"doc":"Converts apparent wind to true wind Parameters      wind : array_like of shape (n, 3) Wind data given as a sequence of points consisting of wind speed, wind angle and boat speed, where the wind speed and wind angle are measured as apparent wind Returns    - converted : numpy.ndarray of shape (n, 3) Array containing the same data as wind_arr, but the wind speed and wind angle now measured as true wind",
"func":1
},
{
"ref":"hrosailing.wind.true_wind_to_apparent",
"url":13,
"doc":"Converts true wind to apparent wind Parameters      wind : array_like of shape (n, 3) Wind data given as a sequence of points consisting of wind speed, wind angle and boat speed, where the wind speed and wind angle are measured as true wind Returns    - converted : numpy.ndarray of shape (n, 3) Array containing the same data as wind_arr, but the wind speed and wind angle now measured as apparent wind",
"func":1
},
{
